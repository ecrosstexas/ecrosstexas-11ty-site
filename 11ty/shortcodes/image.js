...
/** Returns optimized image markup. Expects to receive a source-relative image path (e.g., /assets/img/image.png).
 * Example usage: `{% image '/assets/img/image.png', 'Alt text' %}`.
 */
